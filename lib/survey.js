...
function upload(req, res, auth){
	// SHOULD: log more!  this is fine for dev purposes, but would be impossible to troubleshoot in prod.
	// Who/when/what (IP, datetime, message) consider using a logger lib like npm winston
